...
|------|---------|--------------|
| Easty (Luke) | Samsung Galaxy S24 + Galaxy Ring | Hevy (strength), Samsung Health Accessibility Scraper (Ring HRV/sleep), Health Connect (steps, SpO2), Polar H10 (aerobic sessions) |
...
| Polar H10 | ⏳ Unverified | Polar Flow → Health Connect. Session-only aerobic data. No resting HRV from H10 — primary role is re-validation instrument for Ring HRV coherence. Polar is primary for aerobic session data; Samsung Health is connected to Polar, not the other way around. |
