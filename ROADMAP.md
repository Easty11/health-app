...
| 4b | **Producer interpretive half.** Axis verdict, rendered relations, shared levers with already-in-play filtering against the live ledger, phase-aware gates, ungrouped-marker handling, the endpoint, and the view wired fixture→live. Two forks decided here: cache-on-confirm vs compute-on-read, and verdict depth. | **NEXT** — blocked, see below |
