...
- **Hub shell (#162)** - `/dashboard` is a module tile grid with chat docked, the two panels relocated to their own routes, and `Q63` resolved to structural counts. See `closeout.md` / DECISIONS_LOG #162.
